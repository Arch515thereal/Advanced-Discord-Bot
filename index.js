...
client.on('ready', () => {
    ...
    setInterval(() => {
        const activities_list = [
            ` ${prefix}help | Made By Spexz | Support Us!`,
            ` ${prefix}help | Made By Spexz | Aim High`,
            ` ${prefix}help | Made By Spexz | Have Patience`,
            ` ${prefix}help | Made By Spexz | No Boundaries`,
            ` ${prefix}help | Made By Spexz | Rise Above`
        ];
                ...
                if (now < expirationTime) {
                    ...
                    return message.channel.send({
                        embed: {
                            ...
                            description: `Please wait **${Util.msToTime(timeLeft)}** before running \`${command.name}\` again! \n\`\`\`You may contact the owner (SPΞXZ#0001) to purchase a premium status to remove such cooldowns!\`\`\``,
                            color: "#8B0000",
                            footer: {
